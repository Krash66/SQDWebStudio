dhtmlXDataView.prototype.types.ficon={
	...
	//custom properties
	icons_src_dir: "../Studio/data/SQDimgs",
	image:function(obj){
		return obj.image;
	},
	text:function(obj){
...
dhtmlXDataView.prototype.types.ficonNT = {
    css: "ficon",
    template: dhtmlx.Template.fromHTML("<div align='center'><img onmousedown='return false;' border='0' src='{common.image()}'></div>"),  //<div class='dhx_item_text'>{common.text()}</div>
    template_edit: dhtmlx.Template.fromHTML("<div align='center'><img onmousedown='return false;' border='0' src='{common.image()}'><input class='dhx_item_editor' bind='obj.name'></div>"),
    template_loading: dhtmlx.Template.fromHTML(""),
    width: 75,
    height: 75,
