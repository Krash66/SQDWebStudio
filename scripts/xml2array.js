...
var not_whitespace = new RegExp(/[^\s]/);//This can be given inside the function - I made it a global variable to make the scipt a little bit faster.
var parent_count;
...
//			    alert( 'i = ' + i + "\nxmlDoc.childNodes.length = " + xmlDoc.childNodes.length );
